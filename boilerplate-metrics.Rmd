...
place <- get_acs(geography = "tract", variables = "B19013_001",
                state = "TX", county = place, geometry = TRUE, year = 2020)

ggplot(place, aes(fill = estimate, color = estimate)) +
  geom_sf() +
  coord_sf(crs = 26914) +
  viridis::scale_fill_viridis(option = "magma") +
  viridis::scale_color_viridis(option = "magma") +
  labs(title = "Median household income by census tract in place",
       subtitle = "2020 American Community Survey") +
